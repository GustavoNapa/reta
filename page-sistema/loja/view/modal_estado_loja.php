		...
		<table class="table table-striped">
			<thead>
				<tr class="row">
					<th class="col">
						<div class="row">
							<div class="col-sm-2 col-md-2 text-left">UF</div>
							...
							<div class="col-sm-2 col-md-2 text-right">
								...
								<!-- Importante -->
								<input id="uf-0" value="" type="text" readonly hidden>
					...
					<?php if ( $getCadastroBasicoLoja[1]>0 ): ?>
						<?php foreach ( $getCadastroBasicoLoja[2] as $key => $value): ?>
							...
							<tr class="row">
								<td class="col">
									<div class="row">
										<div class="col-sm-2 col-md-2 text-left"><?=$value->$uf?></div>
										...
										<!-- Importante -->
										<input id="uf-<?=$value->$id?>" value="<?=$value->$uf?>" type="text" readonly hidden>
		...
		<form id="form_cadastro" class="needs-validation" novalidate>
			...
			<div class="row pl-3 pr-3 pt-0">
				<div class="col-md-2 mb-3">
			        <label for="uf" class="small text-dark">UF<span id="text_uf"></span></label>
			        <div class="input-group">
			            <input id="uf" name="uf" type="text" placeholder="UF" class="form-control" value="" minlength="2" maxlength="2" required>
			            <div class="invalid-feedback" style="width: 100%;">
			                Informe  o unidade federal - UF
			            </div>
			        </div>
			    </div>
